        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PostTitle = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    PostContent = table.Column<string>(type: "ntext", nullable: true),
                    PostTeaser = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: true),
